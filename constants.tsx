...
const competitorsData: Competitor[] = [
    { name: 'Polycab Wires', logo: createLogo('P', 'bg-red-600'), overview: 'Leading electrical wire/cable manufacturer.', strengths: ['Strong national network', 'BIS-certified quality'], weaknesses: ['Higher pricing', 'Less customization'], marketPresence: 'High', pricing: '₹70-90', differentiation: 'EcoX offers better eco-coatings vs. Polycab\'s standard lines.' },
    { name: 'Finolex Cables', logo: createLogo('F', 'bg-blue-600'), overview: 'Focus on cables and industrial wires.', strengths: ['Durable, sustainable designs', 'Wide residential use'], weaknesses: ['Limited heavy-duty customization'], marketPresence: 'High', pricing: '₹65-85', differentiation: 'EcoX emphasizes 100 GSM zinc for longer life.' },
    { name: 'Havells India', logo: createLogo('H', 'bg-red-800'), overview: 'Diversified electrical goods.', strengths: ['Strong brand recognition', 'R&D in energy efficiency'], weaknesses: ['More consumer-focused'], marketPresence: 'Very High', pricing: '₹75-95', differentiation: 'EcoX has a sustainability edge vs. Havells\' broader ecosystem.' },
    { name: 'Syska Wires', logo: createLogo('S', 'bg-yellow-500'), overview: 'Affordable wires and LED solutions.', strengths: ['Cost-effective', 'Shock-proof designs'], weaknesses: ['Less industrial durability'], marketPresence: 'High', pricing: '₹60-80', differentiation: 'EcoX provides premium corrosion resistance over budget options.' },
    { name: 'Sterlite Power', logo: createLogo('S', 'bg-indigo-600'), overview: 'High-voltage transmission wires.', strengths: ['Advanced low-loss tech', 'High-tensile wires'], weaknesses: ['Primarily B2B', 'High costs'], marketPresence: 'High (Power Sector)', pricing: '₹80-100', differentiation: 'EcoX focuses on niche customization (e.g., agriculture).' },
    { name: 'Systematic Group', logo: createLogo('S', 'bg-teal-600'), overview: 'Fencing and GI wire specialists.', strengths: ['30+ years experience', 'Corrosion resistance focus'], weaknesses: ['Regional focus', 'Weaker branding'], marketPresence: 'Medium', pricing: '₹65-85', differentiation: 'EcoX innovates with Zn-Al-Mg coatings.' },
];
